...
public class TripHandle {
    ...
    private String pil;
    private String tujuan,harga,makan,kodebus;
    ...
    public void add(){
        ...
        while(!done){
            ...
            System.out.println(" Contoh Tujuan [ Bali ]");
            System.out.print(" Tujuan Perjalanan : ");
            tujuan = sc.nextLine();
            System.out.println(" Contoh Harga [ 452000 ]");
            System.out.print(" Harga Perjalanan : ");
            harga = sc.nextLine();
            System.out.println(" Contoh Makan [ 3 ]");
            ...
            kodebus = sc.nextLine();
            System.out.println("--------------------------------------------------------");
            if(!format.kodeBus(kodebus) || !format.harga(harga)){
                System.out.println(" Data yang Dimasukan Tidak Sesuai!");
                sc.nextLine();
            } else {
                String [] data = {"0",tujuan,harga,makan,kodebus};
    ...
    public void view(){
        ...
        System.out.println("-----------------------------------");
        System.out.println("|   Tujuan   |   Harga   | Jam Berangkat | Makan |");
        System.out.println("|------------|-----------|---------------|-------|");
